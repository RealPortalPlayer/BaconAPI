...
int main(void) {
...

    {
        ...
        ASSERT(strcmp(BA_String_Append(&string, " %s %s %s %s %s"), "GOOD MORNING! HELLO, WORLD! HOW ARE YOU? I'm doing fine! %s %s %s %s %s") == 0);
        ASSERT(strcmp(BA_String_FormatSafe(&string, 4, BA_STRING_FORMAT_SAFE_ARGUMENT_STRING("That's good to hear!"), BA_STRING_FORMAT_SAFE_ARGUMENT_INTEGER(10), BA_STRING_FORMAT_SAFE_ARGUMENT_DOUBLE(12.0), BA_STRING_FORMAT_SAFE_ARGUMENT_CHARACTER('h')), "GOOD MORNING! HELLO, WORLD! HOW ARE YOU? I'm doing fine! That's good to hear! 10 12.000000 h %s") == 0);
    }
