...
typedef enum {
    ...
    BA_STRING_SAFE_FORMAT_TYPE_POINTER,
    ...
    BA_STRING_SAFE_FORMAT_TYPE_SIGNED_SHORT = BA_STRING_SAFE_FORMAT_TYPE_SHORT,
    BA_STRING_SAFE_FORMAT_TYPE_SIGNED_SHORT_INTEGER = BA_STRING_SAFE_FORMAT_TYPE_SHORT,
...
#define BA_STRING_FORMAT_SAFE_ARGUMENT_POINTER(value) BA_STRING_SAFE_FORMAT_TYPE_POINTER, value
