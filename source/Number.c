...
BA_NUMBER_STRING_CONVERT_IMPLEMENTATION(long long, LongLong, LLONG_MIN, LLONG_MAX)
BA_NUMBER_STRING_CONVERT_IMPLEMENTATION(unsigned long long, UnsignedLongLong, 0, ULLONG_MAX)
